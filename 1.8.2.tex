...
\begin{center}
\includegraphics[scale=.4]{images/8.Struktur_ein_SOAP}
...
\begin{center}
\includegraphics[scale=.3]{images/8.Aufbau_eine REST-basierten_Web_Services_Architektur}
...
\begin{center}
\includegraphics[scale=.4]{images/8.Globaler_ueberblick über_GraphQL}
